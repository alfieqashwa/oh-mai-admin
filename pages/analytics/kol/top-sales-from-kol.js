...
export default function TopSalesFromKol() {
  return (
    <div className="pr-12 pl-7">
      {/* Header? */}
      <Header title="KOL - Top Sales from KOL" />
      <GlassHeader title="Top Sales from KOL">
      ...
      {/* Title */}
      <TitleWithBackButton path="/analytics/kol" title="top sales from KOL" />
      ...
      <div className="mt-8">
        ...
        <table className="md:min-w-full text-N0">
          ...
          <tbody className="bg-N700 text-N0">
            {tableBody.map((t) => (
              <tr key={t.id}>
                <td className="py-8 text-center bg-N600 w400 whitespace-nowrap">
                  {t.sn}
                </td>
                <td className="py-8 pl-4 text-left underline capitalize w400">
                  {t.kol}
                </td>
                <td className="py-8 text-right w400 whitespace-nowrap">
                  {t.orders}
                </td>
                <td className="py-8 text-right w400 whitespace-nowrap">
                  {t.itemsSold}
                ...
                <td className="py-8 text-right w400 whitespace-nowrap">
                  ${t.totalCommissions.toFixed(2)}
                </td>
                <td className="py-8 text-center w400">
