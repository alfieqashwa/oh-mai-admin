...
import { DateRangeSelect, TableOrders, Pagination, ChartView, OrderPerformanceCard } from 'components/analytics/customer'
    ...
    <div className="pb-4">
      ...
      <div className="my-8 ml-6 mr-12">
        ...
        <div className="flex items-center justify-between mt-4 mb-7">
          <h4 className="capitalize w600 whitespace-nowrap">customer performance</h4>
          <div className="w-full mx-5 border border-N0 border-opacity-30"></div>
          <BsThreeDotsVertical className="w-6 h-6 mr-2 text-N0" />
        </div>
        {/* performance-cards */}
