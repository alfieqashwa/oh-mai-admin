      ...
      <table className="md:min-w-full text-N0">
        <thead className="bg-N200 bg-opacity-30">
          <tr>
            <th
              scope="col"
              className="px-3 py-4 text-center capitalize w400 whitespace-nowrap"
            >
              s/n
            </th>
            <th
            ...
            <th
              scope="col"
              className="py-4 pl-4 text-right capitalize w400 whitespace-nowrap"
            >
              order ID
            </th>
            <th
              scope="col"
              className="py-4 pl-4 text-center capitalize w400 whitespace-nowrap"
            >
              customer
            </th>
            <th
              scope="col"
              className="py-4 pl-12 text-right capitalize w400 whitespace-nowrap"
            >
              billing
            </th>
            <th
              scope="col"
              className="px-16 py-4 text-right capitalize w400 whitespace-nowrap"
            >
              net sales
            </th>
            <th
              scope="col"
              className="py-4 pr-8 text-center capitalize w400 whitespace-nowrap"
            >
              actions
            </th>
          </tr>
        ...
        <tbody className="bg-N700 text-N0">
          {data?.map((t, i) => (
            <tr key={i}>
              ...
              <td className="py-4 pl-4 text-center underline cursor-pointer w400 whitespace-nowrap">
                {t.person_name}
              </td>
              ...
              <td className="px-16 py-4 text-right underline w400 whitespace-nowrap">
...
//     id: 1,
//     sn: '1',
//     dateTime: '15/05/2021 14:30:23',
//     orderID: 'ORD0000A',
//     customer: 'Fan Leng Leng',
//     billing: [
//       'First Name Last Name, Billing Address, Billing Address, Billing Address, Billing Address, Billing Address, Billing Addr...',
//       'via Credit Card (ECPay)',
//     ],
//     netSales: 120.0,
//   },
//   {
